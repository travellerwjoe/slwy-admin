...
//                 newObj[key] = typeof objs[i][key] === 'object' && deep ? utils.extend(true, objs[i][key]) : objs[i][key]
//             }
//         }
//         return newObj
//     },
...
$.prototype = {
    ...
    css: function (styleObj) {
        ...
        for (var key in styleObj) {
            if (typeof styleObj === 'number' && parseInt(styleObj[key])) styleObj[key] = parseInt(styleObj[key]) + 'px'
    ...
    height: function () {
        return this.el.offsetHeight || this.el.clientHeight || parseInt(this.el.style.height)
    },
...
function SlimScroll(el, options) {
    ...
    function getBarHeight() {
        ...
        barHeight = Math.max((me.height() / me.el.scrollHeight) * me.height(), minBarHeight);
